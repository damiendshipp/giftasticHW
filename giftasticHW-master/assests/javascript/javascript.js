$(document).ready(function(){
    ...
    $('button').on('click', function() {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + animal + "&api_key=071fa38650f444ecb2bec5d555125dfelimit=10";
    ...
    var animals = [''];
        ...
        $('#theButton').on('click', function(){
            ...
            queryURL = "https://api.giphy.com/v1/gifs/search?q=" + animalButton + "&api_key=071fa38650f444ecb2bec5d555125dfelimit=10";
